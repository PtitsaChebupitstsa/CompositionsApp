...
object GameRepositoryImpl : GameRepository {
    ...
    override fun generateQuestion(maxSumValue: Int, countOfOptions: Int): Question {
        ...
        val from = max(
            rightAnswer - countOfOptions,
            MIN_ANSWER_VALUE
        )//правильный вариант рядом с правильным ответом( с нижней границей диапазона MIN_ANSWER_VALUE)
        val to = min(maxSumValue, rightAnswer + countOfOptions)//максимальное значение
